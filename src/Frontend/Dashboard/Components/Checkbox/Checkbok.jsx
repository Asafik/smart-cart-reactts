...
const Checkbox = () => {
    ...
    const [baruUntukmuCheckboxStates, setBaruUntukmuCheckboxStates] = useState([false, false, false]);
    const [aktivitasAkunCheckboxStates, setAktivitasAkunCheckboxStates] = useState([false, false, false]);
    const [browserCheckboxStates, setBrowserCheckboxStates] = useState([false, false, false]);
    const [perangkatCheckboxStates, setPerangkatCheckboxStates] = useState([false, false, false]);
        ...
        return checkboxStates.map((isChecked, index) => (
            <p key={index}>
                <div className={`custom-checkbox ${group}`}>
                    ...
                    />
                    <label htmlFor={`checkbox-${group}-${index}`} className='checkmark'></label>
                </div>
            </p>
        ));
    };
